...
export default function AuthenticatedLayout({ children }) {
    ...
    const { activeTask, isMinimized, timeRemaining, toggleMinimize } =
        useFocusTimer();
        ...
        <div className="flex flex-col md:flex-row min-h-screen mesh-gradient dark:bg-slate-950 text-slate-900 dark:text-slate-100 antialiased selection:bg-emerald-100 selection:text-emerald-900 transition-colors duration-500">
            ...
            {toast.show && (
                <div className="fixed top-12 left-1/2 -translate-x-1/2 z-[200] w-full max-w-sm px-6 transition-all duration-500 transform">
                    <div
                        className={`rounded-[2rem] p-5 shadow-2xl flex items-center border-4 border-white/10 backdrop-blur-xl ${
                            toast.type === "success"
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-white font-bold tracking-tight text-sm leading-tight">
                                {toast.message}
                            </p>
                        </div>
                        <button
            ...
            >
                ...
                <div className="h-24 flex items-center border-b border-white/50 dark:border-slate-800/50 relative overflow-hidden">
                    <div
                        className={`flex items-center transition-all duration-500 w-full ${sidebarCollapsed ? "px-0 justify-center" : "px-6"}`}
                    >
                        <Link
                        ...
                        >
                            ...
                            <span
                                className={`text-2xl font-black text-slate-800 dark:text-white tracking-tight whitespace-nowrap transition-all duration-500 overflow-hidden ${sidebarCollapsed ? "opacity-0 max-w-0 ml-0 pointer-events-none" : "opacity-100 max-w-xs ml-3"}`}
                            >
                                Landas
                ...
                <nav className="flex-1 px-4 space-y-2 overflow-y-auto hide-scrollbar pt-4">
                    <p
                        className={`text-[9px] font-black text-slate-300 uppercase tracking-[0.3em] px-4 whitespace-nowrap transition-all duration-500 overflow-hidden ${sidebarCollapsed ? "opacity-0 max-w-0 mb-0 h-0" : "opacity-100 max-w-xs mb-4 h-auto"}`}
                    >
                        Main Menu
                    </p>
                    ...
                    >
                        ...
                        <span
                            className={`font-black text-[10px] uppercase tracking-[0.2em] whitespace-nowrap transition-all duration-500 overflow-hidden ${sidebarCollapsed ? "opacity-0 max-w-0" : "opacity-100 max-w-xs ml-0"}`}
                        >
                            Dashboard
                        </span>
                    </Link>
                ...
                <div className="p-4 border-t border-white/50 dark:border-slate-800/50">
                        ...
                        {userMenu && (
                            <div className="absolute bottom-full left-0 mb-4 w-64 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-800 p-2 z-50 overflow-hidden animate-in fade-in slide-in-from-bottom-2">
                                ...
                                <Link
                                    ...
                                    className="flex items-center px-4 py-3 text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 hover:text-emerald-700 dark:hover:text-emerald-400 transition-all rounded-2xl group/item"
                                >
                                    <div className="p-2 bg-slate-50 dark:bg-slate-800 rounded-xl mr-3 group-hover/item:bg-emerald-100 dark:group-hover/item:bg-emerald-900/40 transition-colors">
                                        <svg
                                            className="w-4 h-4 text-slate-400 group-hover/item:text-emerald-600 dark:group-hover/item:text-emerald-400"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                ...
                                >
                                    <div className="p-2 bg-red-50/50 dark:bg-red-900/20 rounded-xl mr-3 group-hover/item:bg-red-100 dark:group-hover/item:bg-red-900/40 transition-colors">
                                        <svg
                                            className="w-4 h-4 text-red-400 group-hover/item:text-red-600 dark:group-hover/item:text-red-400"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                    ...
                    >
                        <svg
                            className={`w-5 h-5 transition-transform duration-500 ${sidebarCollapsed ? "rotate-180" : ""}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
            ...
            {/* Mobile Top Header */}
            <nav className="md:hidden bg-white/40 dark:bg-slate-900/60 backdrop-blur-xl border-b border-white dark:border-slate-800 sticky top-0 z-[60] w-full">
                    ...
                    {userMenu && (
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                exit={{ y: 10, opacity: 0 }}
                                className="absolute top-20 right-6 w-64 bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl border border-slate-100 dark:border-slate-800 p-3 z-[80] overflow-hidden"
                            >
                                <div className="px-5 py-4 mb-2">
                                    <p className="text-[10px] font-black text-slate-300 dark:text-slate-600 uppercase tracking-[0.2em] mb-1">
                                        Signed in as
                                    </p>
                                ...
                                <div className="space-y-1">
                                    <Link
                                        href={route("profile.edit")}
                                        className="flex items-center px-5 py-4 text-sm font-bold text-slate-600 dark:text-slate-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 hover:text-emerald-700 dark:hover:text-emerald-400 transition-all rounded-[1.5rem] group/item"
                                    >
                                        <div className="p-2 bg-slate-50 dark:bg-slate-800 rounded-xl mr-4 group-hover/item:bg-emerald-100 dark:group-hover/item:bg-emerald-900/40 transition-colors">
                                            <User
                                                size={18}
                                                className="text-slate-400 group-hover/item:text-emerald-600 dark:group-hover/item:text-emerald-400"
                                            />
                                        </div>
                                        My Profile
                                    </Link>
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 z-[100] px-6 pb-8">
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl rounded-[2.5rem] p-2 flex items-center justify-between shadow-2xl shadow-slate-200/50 dark:shadow-black/40 border border-white/50 dark:border-white/10">
                    <MotionLink
                        href={route("dashboard")}
                        whileTap={{ scale: 0.9 }}
                        className={`flex-1 flex flex-col items-center justify-center py-3 rounded-[1.8rem] transition-all relative ${route().current("dashboard") ? "text-white" : "text-slate-500 hover:text-emerald-500"}`}
                    >
                        {route().current("dashboard") && (
                            <motion.div
                                layoutId="mobile-nav-pill"
                                className="absolute inset-0 bg-emerald-500 rounded-[1.8rem] z-0 shadow-lg shadow-emerald-200/50 dark:shadow-none"
                                transition={{ type: "spring", stiffness: 300, damping: 30 }}
                            />
                        )}
                        <LayoutDashboard size={20} className="relative z-10" />
                        <span
                            className={`text-[8px] font-black uppercase tracking-widest mt-1.5 relative z-10 ${route().current("dashboard") ? "opacity-100" : "opacity-40"}`}
                        >
                            Home
                        </span>
                    </MotionLink>
                    ...
                    <MotionLink
                        href={route("todos.index")}
                        whileTap={{ scale: 0.9 }}
                        className={`flex-1 flex flex-col items-center justify-center py-3 rounded-[1.8rem] transition-all relative ${route().current("todos.*") ? "text-white" : "text-slate-500 hover:text-emerald-500"}`}
                    >
                        {route().current("todos.*") && (
                            <motion.div
                                layoutId="mobile-nav-pill"
                        ...
                        <span
                            className={`text-[8px] font-black uppercase tracking-widest mt-1.5 relative z-10 ${route().current("todos.*") ? "opacity-100" : "opacity-40"}`}
                        >
                            Sprint
                        </span>
                    </MotionLink>
                    ...
                    <MotionLink
                        href={route("habits.index")}
                        whileTap={{ scale: 0.9 }}
                        className={`flex-1 flex flex-col items-center justify-center py-3 rounded-[1.8rem] transition-all relative ${route().current("habits.*") ? "text-white" : "text-slate-500 hover:text-emerald-500"}`}
                    >
                        ...
                        <span
                            className={`text-[8px] font-black uppercase tracking-widest mt-1.5 relative z-10 ${route().current("habits.*") ? "opacity-100" : "opacity-40"}`}
                        >
                            Discipline
                        </span>
                    </MotionLink>
                    ...
                    <MotionLink
                        href={route("mastery.index")}
                        whileTap={{ scale: 0.9 }}
                        className={`flex-1 flex flex-col items-center justify-center py-3 rounded-[1.8rem] transition-all relative ${route().current("mastery.*") ? "text-white" : "text-slate-500 hover:text-emerald-500"}`}
                    >
                        ...
                        <span
                            className={`text-[8px] font-black uppercase tracking-widest mt-1.5 relative z-10 ${route().current("mastery.*") ? "opacity-100" : "opacity-40"}`}
                        >
                            Vision
                        </span>
                    </MotionLink>
                            ...
                            <div className="relative transform overflow-hidden rounded-[3rem] bg-white dark:bg-slate-900 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-md border-4 border-white dark:border-slate-800 animate-in zoom-in-95 duration-300">
                                <div className="p-10">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <h3 className="text-3xl font-black text-slate-800 dark:text-white tracking-tighter leading-none mb-4">
                                            {confirmModal.title}
                                        </h3>
                                        <p className="text-slate-400 dark:text-slate-500 font-bold text-base leading-relaxed mb-10">
