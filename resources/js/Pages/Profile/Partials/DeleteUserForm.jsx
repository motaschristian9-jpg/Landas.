    ...
    return (
        <section className={`space-y-6 ${className}`}>
            ...
            <button 
                ...
                className="bg-rose-500 text-white px-10 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-rose-600 transition-all shadow-lg shadow-rose-100 active:scale-95"
            >
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-10">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h2 className="text-3xl font-black text-slate-800 tracking-tighter leading-none mb-4">
                        ...
                        <div className="w-full mb-8">
                            ...
                            <TextInput
                                ...
                                className="block w-full !rounded-2xl !border-slate-100 !bg-slate-50/50 focus:!ring-rose-500/20 focus:!border-rose-500 !py-4 transition-all text-center"
                                isFocused
                        ...
                        <div className="flex w-full space-x-4">
                            ...
                            <button 
                                type="submit"
                                disabled={processing}
                                className="flex-1 py-5 rounded-[1.5rem] bg-rose-500 hover:bg-rose-600 text-white font-black text-xs uppercase tracking-widest shadow-xl shadow-rose-100 transition-all active:scale-95 disabled:opacity-50"
                            >
                                Delete Everything
                            </button>
                        </div>
